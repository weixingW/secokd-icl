...
# ARC_EASY
ARC_EASY_LABELS = [("A", "B", "C", "D")]
ARC_EASY_PROMPT_FORMATS = ["Question: {}\nOptions: {}\nAnswer: {}."]
ARC_EASY_PREFIX_NARRATIVES = [""]
ARC_EASY_PROMPT_PARAMS = {
    i: {
        "labels": ARC_EASY_LABELS[i],
        "prompt_format": ARC_EASY_PROMPT_FORMATS[i],
        "prefix_narrative": ARC_EASY_PREFIX_NARRATIVES[i],
    }
    for i in range(len(ARC_EASY_PROMPT_FORMATS))
}
...
PROMPT_PARAMS = {
    ...
    "arc_easy": ARC_EASY_PROMPT_PARAMS,
}