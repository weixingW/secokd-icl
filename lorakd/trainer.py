"""trainer class to perform lora kd"""
import pdb
import gc
import sys
sys.path.append("..")
from logit_lens import *
from SeCoKD.lorakd.kd_utils import rank_logits, rank_logits_multi_token
from transformers import Trainer, StoppingCriteriaList
...
class KDTrainer(Trainer):
    ...
    def __init__(self,*args, pad_token=None,teacher_model=None,tokenizer=None,stop_word_ids=None, **kwargs):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        with torch.no_grad():
            ...
            outputs = self.teacher.generate(**teacher_input, do_sample=False,max_new_tokens=200, stopping_criteria=stopping_criteria)
        ...
        eval_out_student = model.generate(**student_input, return_dict_in_generate=True, do_sample=False,max_new_tokens=200, stopping_criteria=stopping_criteria)
